...
//        textura canvas que se mueve con la cámara.
...
export class Cielo {
    ...
    // Accesibles por subclases (convención _)
    _colorArriba;
    _colorHorizonte;
    ...
    // Método plantilla — subclases pintan su propio cielo en canvas
    _generarTextura() {
        const W = 512, H = 256;
    ...
    // Subclases diurnas sobreescriben esto; nocturnas devuelven null
